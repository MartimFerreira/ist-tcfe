...
fprintf(resistance_tab, "$V_{CC}\\;(V)$ & %.6e\\\\ \\hline\n", VCC);
fprintf(resistance_tab, "$R_{S}\\;(\\Omega)$ & %.6e\\\\ \\hline\n", RS);
fprintf(resistance_tab, "$R_{E1}\\;(\\Omega)$ & %.6e\\\\ \\hline\n", RE1);
fprintf(resistance_tab, "$R_{C1}\\;(\\Omega)$ & %.6e\\\\ \\hline\n", RC1);
fprintf(resistance_tab, "$R_{B1}\\;(\\Omega)$ & %.6e\\\\ \\hline\n", RB1);
fprintf(resistance_tab, "$R_{B2}\\;(\\Omega)$ & %.6e\\\\ \\hline\n", RB2);
fprintf(resistance_tab, "$R_{E2}\\;(\\Omega)$ & %.6e\\\\ \\hline\n", RE2);

fclose(resistance_tab);

resistance1_tab = fopen("resistance1_tab.tex", "w");

fprintf(resistance1_tab, "$V_T\\;(V)$ & %.1e\\\\ \\hline\n", VT);
fprintf(resistance1_tab, "$\\beta_{FN}$ & %.1e\\\\ \\hline\n", BFN);
fprintf(resistance1_tab, "$V_{AFN}\\;(V)$ & %.6e\\\\ \\hline\n", VAFN);
fprintf(resistance1_tab, "$V_{EBON}\\;(V)$ & %.6e\\\\ \\hline\n", VEBON);
fprintf(resistance1_tab, "$\\beta_{FP}$ & %.6e\\\\ \\hline\n", BFP);
fprintf(resistance1_tab, "$V_{AFP}\\;(V)$ & %.6e\\\\ \\hline\n", VAFP);
...
fprintf(resultsDC1_tab, "$R_B\\;(\\Omega)$ & %.1e\\\\ \\hline\n", RB);
fprintf(resultsDC1_tab, "$V_{eq}\\;(V)$ & %.1e\\\\ \\hline\n", VEQ);
fprintf(resultsDC1_tab, "$I_{B1}\\;(A)$ & %.6e\\\\ \\hline\n", IB1);
fprintf(resultsDC1_tab, "$I_{C1}\\;(A)$ & %.6e\\\\ \\hline\n", IC1);
fprintf(resultsDC1_tab, "$I_{E1}\\;(A)$ & %.6e\\\\ \\hline\n", IE1);
fprintf(resultsDC1_tab, "$V_{E1}\\;(V)$ & %.1e\\\\ \\hline\n", VE1);
fprintf(resultsDC1_tab, "$V_{O1}\\;(V)$ & %.1e\\\\ \\hline\n", VO1);
fprintf(resultsDC1_tab, "$V_{CE}\\;(V)$ & %.1e\\\\ \\hline\n", VCE);
...
fprintf(resultsDC2_tab, "$V_{I2}\\;(V)$ & %.1e\\\\ \\hline\n", VI2);
fprintf(resultsDC2_tab, "$I_{E2}\\;(A)$ & %.6e\\\\ \\hline\n", IE2);
fprintf(resultsDC2_tab, "$I_{C2}\\;(A)$ & %.6e\\\\ \\hline\n", IC2);
fprintf(resultsDC2_tab, "$V_{O2}\;(V)$ & %.1e\\\\ \\hline\n", VO2);
...
fprintf(resultsAC1_tab, "$Gain_1\\;(without C_E)$ & %.1e\\\\ \\hline\n", AV1simplew);
fprintf(resultsAC1_tab, "$Gain_1\\;(with C_E)$ & %.1e\\\\ \\hline\n", AV1simple2);
fprintf(resultsAC1_tab, "$Z_{I1}\\;(\\Omega)$ & %.1e\\\\ \\hline\n", ZI1);
fprintf(resultsAC1_tab, "$Z_{O1}\\;(\\Omega)$ & %.1e\\\\ \\hline\n", ZO1);
...
fprintf(resultsAC2_tab, "$Gain_2$ & %.1e\\\\ \\hline\n", AV2);
fprintf(resultsAC2_tab, "$Z_{I2}\\;(\\Omega)$ & %.1e\\\\ \\hline\n", ZI2);
fprintf(resultsAC2_tab, "$Z_{O2}\\;(\\Omega)$ & %.1e\\\\ \\hline\n", ZO2);
