...
In this section, ngspice simulation results for the circuit shown above are presented. It was confirmed that the form of the output matched the form of the input and that the transistor functioned in the forward active region.
